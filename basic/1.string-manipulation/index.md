...
|問題|解答例プログラム|
|:-------------|:------------------|
|11--19|[ソースコードと実行例](./answer/basic_1_answer.md)|
|20|[文字列の分割（特定の文字で分割）](./answer/answer20.py)|
|21|[正規表現にマッチする行を出力](./answer/answer21.py)|
|22|[複数の正規表現のいずれかにマッチする行を出力](./answer/answer22.py)|
|23|[正規表現にマッチする部分を抽出](./answer/answer23.py)|
|24|[文字列の分割（正規表現にマッチする位置で分割）](./answer/answer24.py)|
